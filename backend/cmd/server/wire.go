...
func provideCleanup(
	...
	accountWindowUsageRecorder *service.AccountWindowUsageRecorder,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"AccountWindowUsageRecorder", func() error {
				if accountWindowUsageRecorder != nil {
					accountWindowUsageRecorder.Stop()
				}
				return nil
			}},
