...
const (
	...
	FieldDecisiveProbeCount = "decisive_probe_count"
...
var (
	...
	// DefaultDecisiveProbeCount holds the default value on creation for the "decisive_probe_count" field.
	DefaultDecisiveProbeCount int
)
...
// ByDecisiveProbeCount orders the results by the decisive_probe_count field.
func ByDecisiveProbeCount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDecisiveProbeCount, opts...).ToFunc()
}
