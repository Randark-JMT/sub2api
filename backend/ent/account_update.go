...
func (_u *AccountUpdate) SetWindowTrackingEnabled(v bool) *AccountUpdate {
	_u.mutation.SetWindowTrackingEnabled(v)
	return _u
}

// SetNillableWindowTrackingEnabled sets the "window_tracking_enabled" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableWindowTrackingEnabled(v *bool) *AccountUpdate {
	if v != nil {
		_u.SetWindowTrackingEnabled(*v)
	}
	return _u
}
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.WindowTrackingEnabled(); ok {
...
// SetWindowTrackingEnabled sets the "window_tracking_enabled" field.
func (_u *AccountUpdateOne) SetWindowTrackingEnabled(v bool) *AccountUpdateOne {
	_u.mutation.SetWindowTrackingEnabled(v)
	return _u
}

// SetNillableWindowTrackingEnabled sets the "window_tracking_enabled" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableWindowTrackingEnabled(v *bool) *AccountUpdateOne {
	if v != nil {
		_u.SetWindowTrackingEnabled(*v)
	}
	return _u
