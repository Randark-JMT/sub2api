...
type AccountWindowUsageHistory struct {
	...
	DecisiveProbeCount int `json:"decisive_probe_count,omitempty"`
...
func (*AccountWindowUsageHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case accountwindowusagehistory.FieldCreatedAt, accountwindowusagehistory.FieldUpdatedAt, accountwindowusagehistory.FieldWindowStart, accountwindowusagehistory.FieldWindowEnd, accountwindowusagehistory.FieldLastProbeAt, accountwindowusagehistory.FieldFinalizedAt:
...
func (_m *AccountWindowUsageHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case accountwindowusagehistory.FieldDecisiveProbeCount:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field decisive_probe_count", values[i])
			} else if value.Valid {
				_m.DecisiveProbeCount = int(value.Int64)
			}
...
func (_m *AccountWindowUsageHistory) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("decisive_probe_count=")
	builder.WriteString(fmt.Sprintf("%v", _m.DecisiveProbeCount))
	builder.WriteString(", ")
